...
<?php get_header(); ?>
<main class="p-archive p-archive-column">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="nine columns">
        <h2 class="c-contenttitle mt-5">アドコラム一覧</h2>
        ...
        <div class="c-search-categorybox">
          ...
          <ul class="c-search-categorybox__list">
            ...
            ?>
            <li class="item">
                <a href="<?php echo home_url('/'); ?>?column_cat=<?php echo $term->slug; ?>"><?php echo $term->name; ?></a>
            </li>
            <?php endforeach; ?>     
          </ul>
        </div>
